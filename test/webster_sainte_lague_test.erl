...
webster_sainte_lague_2021_federal_case() ->
    Votes    = [ {spd, 11_949_756}, {cdu, 11_173_806}, {grn, 6_848_215}, {fdp, 5_316_698}, {afd, 4_802_097}, {lnk, 2_269_993} ],
    ...
    % Real CDU/CSU = 196
    % Real Greens = 118
    [ {spd, SPD, _}, {cdu, CDU, _}, {grn, GRN, _}, {fdp, 92, _}, {afd, 83, _}, {lnk, 39, _}] = Rankings,
